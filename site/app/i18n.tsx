...
const copy = {
  en: {
    ...
    metadata: {
      home: {
        ...
        description: "Local-first voice typing with Quick Dictate, focus-safe spoken edits, versioned undo, and hands-free send on macOS 26.",
      },
      changelog: {
    ...
    home: {
      ...
      lede: "Speak once to write, then keep speaking to revise. Quick Dictate, focus-safe versioned edits, and Apple Speech stay inside a local-first, open-source Mac workflow.",
      ...
      productEyebrow: "Lerro Edit", productHeadline: "Write it. Say the change. Keep going.", productCopy: "Follow the transcript in real time, let a short silence finish Quick Dictate, then speak a focus-safe edit or restore the prior version.",
      screenshots: [
      ...
      downloadEyebrow: "Lerro 1.5", downloadHeadline: "Keep speaking after Lerro writes.", downloadCopy: "Signed, notarized, and ready for Apple silicon Macs running macOS 26 or later.", changelog: "Read the changelog",
    },
    changelog: {
  ...
  zh: {
    ...
    metadata: {
      home: { title: "Lerro — macOS 原生语音输入", ogTitle: "Lerro — 开口说话，Mac 为你打字。", description: "在 macOS 26 上按一次 Fn 快速听写，继续说一句即可安全修改、逐版恢复或确认后发送。" },
    ...
    home: {
      ...
      lede: "说一句完成写入，继续说一句完成修改。Quick Dictate、焦点安全的逐版编辑和 Apple Speech 共同构成本地优先、开源的 Mac 工作流。", download: "下载 macOS 版", source: "查看源代码", requirements: "永久免费 · Apple 芯片 · macOS 26+",
      ...
      productEyebrow: "Lerro Edit", productHeadline: "说完写入，继续说就能改。", productCopy: "实时查看转写，Quick Dictate 在短暂静音后收尾；随后可用语音安全修改，并逐版恢复。",
      screenshots: [
      ...
      downloadEyebrow: "Lerro 1.5", downloadHeadline: "Lerro 写完以后，继续说一句就能改。", downloadCopy: "已签名、已公证，适用于运行 macOS 26 或更高版本的 Apple 芯片 Mac。", changelog: "阅读更新日志",
    },
