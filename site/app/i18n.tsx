...
const copy = {
  en: {
    ...
    metadata: {
      home: {
        ...
        description: "Fast, local-first voice typing powered by Apple Speech on macOS 26. Free, open source, and private by architecture.",
      },
      changelog: {
    ...
    home: {
      ...
      lede: "Lerro turns speech into text at your cursor with Apple's native Speech framework. Fast, accurate, local-first, and open source.",
      download: "Download for macOS", source: "View source", requirements: "Free forever · Apple silicon · macOS 26+",
      demoTitle: "Untitled", demoDate: "AUGUST 4", demoCopy: "Voice becomes text right where the cursor is.", demoTags: ["Apple Speech", "On-device"],
      demoLabel: "Animated recreation of Lerro's macOS listening and processing HUD", demoDescription: "The HUD listens with a live ten-bar waveform, then displays Lerro's three-dot processing state.",
      ...
      paths: [
        ...
        { index: "03", title: "Refine", copy: "Polish, rewrite, or ask with an optional local MLX model or your own cloud API key.", flow: ["Transcript", "MLX or BYOK", "Cursor"] },
      ],
      productEyebrow: "Made for macOS", productHeadline: "Feels native from the first shortcut.", productCopy: "Configure the keys you already use, see the same responsive HUD across apps, and keep every setting close at hand.",
      screenshots: [
        { file: "lerro-home-light.png", alt: "Lerro 1.2 home screen showing local activity, shortcuts, and private on-device data" },
        ...
        { file: "lerro-settings-light.png", alt: "Lerro shortcut settings for Dictate, Translate, and Ask", caption: "Dictate, Translate, and Ask each support up to four custom shortcuts." },
      ],
      ...
      downloadEyebrow: "Lerro 1.2", downloadHeadline: "Give your keyboard a voice.", downloadCopy: "Signed, notarized, and ready for Apple silicon Macs running macOS 26 or later.", changelog: "Read the changelog",
    },
    changelog: {
  ...
  zh: {
    ...
    metadata: {
      home: { title: "Lerro — macOS 原生语音输入", ogTitle: "Lerro — 开口说话，Mac 为你打字。", description: "基于 macOS 26 Apple Speech 的快速、本地优先语音输入工具。永久免费、开源，隐私从架构开始。" },
    ...
    home: {
      ...
      lede: "Lerro 通过 Apple 原生 Speech 框架，将语音转换为当前光标处的文字。快速、准确、本地优先、开源。", download: "下载 macOS 版", source: "查看源代码", requirements: "永久免费 · Apple 芯片 · macOS 26+",
      demoTitle: "未命名文稿", demoDate: "8 月 4 日", demoCopy: "语音会在光标所在的位置变成文字。", demoTags: ["Apple Speech", "设备端"], demoLabel: "Lerro macOS 聆听与处理 HUD 的动态演示", demoDescription: "HUD 通过十段动态波形显示聆听状态，随后展示 Lerro 的三点处理状态。",
      ...
      paths: [
        ...
        { index: "03", title: "润色", copy: "使用可选的本地 MLX 模型或自己的云端 API Key 进行润色、改写或提问。", flow: ["转写结果", "MLX 或 BYOK", "光标"] },
      ],
      productEyebrow: "为 macOS 而生", productHeadline: "从第一个快捷键开始，就像原生应用。", productCopy: "设置你已经在用的按键，在各个应用中看到一致、灵敏的 HUD，把每项设置放在随手可及的位置。",
      screenshots: [
        { file: "lerro-home-light.png", alt: "Lerro 1.2 中文首页，显示本地活动、快捷键和设备端私密数据" },
        { file: "lerro-onboarding-shortcuts-light.png", alt: "Lerro 中文引导识别 Fn 快捷键，并让用户选择按住或切换模式", caption: "快捷键设置会测试每一次准确的按下和松开事件，再继续下一步。" },
        { file: "lerro-settings-light.png", alt: "Lerro 中文快捷键设置，包含听写、翻译和提问", caption: "听写、翻译和提问各自支持最多四个自定义快捷键。" },
      ],
      ...
      downloadEyebrow: "Lerro 1.2", downloadHeadline: "让键盘拥有声音。", downloadCopy: "已签名、已公证，适用于运行 macOS 26 或更高版本的 Apple 芯片 Mac。", changelog: "阅读更新日志",
    },
