...
const copy = {
  en: {
    ...
    home: {
      ...
      productEyebrow: "Made for macOS", productHeadline: "The right voice in every app.", productCopy: "Set app-specific writing styles, speak exact snippets, and teach corrections while the responsive HUD shows the active app profile.",
      screenshots: [
        { file: "lerro-home-light.png", alt: "Lerro 1.3 home screen showing exact personalization counts and Command shortcut" },
      ...
      downloadEyebrow: "Lerro 1.3", downloadHeadline: "Give every app the right voice.", downloadCopy: "Signed, notarized, and ready for Apple silicon Macs running macOS 26 or later.", changelog: "Read the changelog",
    },
    changelog: {
  ...
  zh: {
    ...
    home: {
      ...
      demoTitle: "未命名文稿", demoDate: "8 月 10 日", demoCopy: "语音会根据当前应用，在光标处变成合适的文字。", demoTags: ["Apple Speech", "感知应用"], demoLabel: "Lerro macOS 聆听与处理 HUD 的动态演示", demoDescription: "HUD 通过十段动态波形显示聆听状态，随后展示 Lerro 的三点处理状态。",
      ...
      productEyebrow: "为 macOS 而生", productHeadline: "每个应用，都用合适的表达。", productCopy: "设置应用专属语气，说出精确快捷语，通过修正持续学习；灵敏的 HUD 会显示当前生效的应用配置。",
      screenshots: [
        { file: "lerro-home-light.png", alt: "Lerro 1.3 中文首页，显示准确的个性化计数和指令快捷键" },
      ...
      downloadEyebrow: "Lerro 1.3", downloadHeadline: "让每个应用拥有合适的表达。", downloadCopy: "已签名、已公证，适用于运行 macOS 26 或更高版本的 Apple 芯片 Mac。", changelog: "阅读更新日志",
    },
